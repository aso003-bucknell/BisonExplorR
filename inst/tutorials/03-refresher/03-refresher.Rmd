...
![A Google Sheets URL with the long ID between /d/ and /edit highlighted.](images/Sheet_ID.png){width="100%"}
...
grade_this({
  ...
  if (!user_object_exists("class_data")) {
    fail("Create an object called class_data using read.csv(csv_url).")
  }

  if (!is.data.frame(user_object_get("class_data"))) {
